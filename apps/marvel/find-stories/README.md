...
This is a sample template for find-all-characters - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name find-all-characters \
...
```bash
sam logs -n HelloWorldFunction --stack-name find-all-characters --tail
```
...
```bash
aws cloudformation delete-stack --stack-name find-all-characters
```
