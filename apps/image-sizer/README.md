...
This is a sample template for image-sizer - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name image-sizer --tail
```
...
```bash
aws cloudformation delete-stack --stack-name image-sizer
```
